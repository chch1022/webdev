...
const coursesSlice = createSlice({
  ...
  reducers: {
    ...
    setCourse: (state, { payload: course }) => {
      // This action is for setting the current course being edited
      // We'll handle this in the component's local state instead
      // This action can be used for other course-setting needs
    },
  },
});
